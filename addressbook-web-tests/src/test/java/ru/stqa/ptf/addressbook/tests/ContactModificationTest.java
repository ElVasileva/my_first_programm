...
public class ContactModificationTest extends TestBase {
  ...
  public void testContactModification() throws Exception {
    ...
    if (!app.getContactHelper().isThereAContact()) {
      app.getContactHelper().createContact(new ContactData(0,"Ivan", "Ivanovich", "Ivanov", "Vanja", "NewTitle", "Company", "Saint-Petersburg, Nevsky av., 1", "Ivan", "876876676", "8798788", "9879898", "vanja@mail.ru", "Ivanov@mail.ru", "Iv_iv@mail.ru", "7666766", "new_group", "Prosvetschenija, 1", "777789", "NewPerson"), true);
    }
